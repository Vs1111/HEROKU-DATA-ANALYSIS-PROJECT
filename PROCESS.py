...
df = pd.read_csv("realipldatset\points_table.csv")
df1 =pd.read_excel("realipldatset\homes_add.xlsx")
df.rename(columns={'name': 'Team_Name', 'matcheswon': 'Matches_Won'}, inplace=True)
df2 =pd.read_excel("realipldatset\Copy of Book1.xlsx")
df3 =pd.read_csv("realipldatset\matches.csv")
