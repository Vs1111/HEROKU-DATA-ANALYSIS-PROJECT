...
df = pd.read_csv("E:\\real ipl datset\\points_table.csv")
df1 =pd.read_excel("E:\\real ipl datset\\homes_add.xlsx")
df.rename(columns={'name': 'Team_Name', 'matcheswon': 'Matches_Won'}, inplace=True)
df2 =pd.read_excel("E:\\real ipl datset\\Copy of Book1.xlsx")
df3 =pd.read_csv("E:\\real ipl datset\\matches.csv")
